...
function Swiper(container, swiperOptions) {
  ...
  let width = options.width || container.getBoundingClientRect().width || container.offsetWidth
  let height = options.height || container.getBoundingClientRect().height || container.offsetHeight
